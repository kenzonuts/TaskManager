...
```bash
cd Backend/NebulaCore/NebulaCore
...
> Catatan: sampai Fase 2 selesai, connection string masih boleh mengarah ke SQL Server lokal **atau** langsung ke Supabase Postgres setelah Npgsql dipasang. Fase 0 hanya memastikan secret tidak ada di repo.
